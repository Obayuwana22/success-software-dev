...
import projectOne from "../images/thumbnail/lockedIn.png";
import projectTwo from "../images/thumbnail/kropp fitness.png";
import projectThree from "../images/thumbnail/comfy store.png";
import projectFour from "../images/thumbnail/colourist.png";
...
const Projects = () => {
  const projects = [
    ...
    // },
    {
      ...
      live: "https://lockedin-teal.vercel.app/",
      featured: false,
    },
    {
      ...
      live: "https://kropp-fitness.vercel.app/",
      featured: false,
    },
    {
      title: "Comfy Store",
      ...
      live: "https://comfy-store-delta-two.vercel.app/",
      featured: false,
    },

    {
      ...
      live: "https://courageobayuwana.com/",
      featured: false,
    },
  ];
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {otherProjects.map((project) => (
              <div
                key={project.title}
                className="group bg-slate-800/30 backdrop-blur-sm rounded-2xl overflow-hidden border border-blue-500/20 hover:border-blue-400/40 transition-all duration-300 hover:transform hover:scale-105 flex flex-col"
              >
